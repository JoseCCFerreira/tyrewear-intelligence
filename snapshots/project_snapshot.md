...
Generated at: `2026-05-11T09:44:32`

## Repository

- Latest commit: `84f7ecb chore: refresh tyrewear generated artifacts`
...
| `docs_html/index.html` | 5685 bytes |
| `docs_html/presentation.html` | 4313 bytes |
| `docs_html/style.css` | 1926 bytes |
| `README.md` | 8550 bytes |
| `requirements.txt` | 123 bytes |
| `app.py` | 197 bytes |
| `src/tyrewear_app.py` | 26218 bytes |
...
| `scripts/create_snapshot.py` | 3733 bytes |
...
| `data/processed/tyrewear.duckdb` | 6041600 bytes |
